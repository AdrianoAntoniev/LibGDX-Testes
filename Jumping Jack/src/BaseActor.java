...
public class BaseActor extends Group {
	...
	/**
	 * If this object moves completely past the world bounds, adjust its
	 * position to the opposite side of the world.
	 */
	...
	/**
	 * Convenience method for creating a 1-frame animation from a single
	 * texture.
	 * 
	 * @param fileName
	 *            names of image file
	 ...
	 * current speed is zero (direction is undefined), direction will be set to
	 * 0 degrees.
	 * 
	 * @param speed
	...
	/**
	 * Sets the angle of motion (in degrees). If current speed is zero, this
	 * will have no effect.
	 * 
	 * @param angle
	 *            of motion (degrees)
	...
	/**
	 * Get the angle of motion (in degrees), calculated from the velocity
	 * vector. <br>
	 * To align actor image angle with motion angle, use
	 ...
	 * 
	 * @param dt
	 *            Time elapsed since previous frame (delta time); typically
	 *            obtained from <code>act</code> method.
	 * @see #acceleration
	 * @see #deceleration
	 * @see #maxSpeed
	 */
	 ...
	 * <br>
	 * Vertices of polygon lie on the ellipse contained within bounding
	 ...
	 * BaseActor away from other BaseActor along minimum translation vector
	 * until there is no overlap.
	 * 
	 * @param other
	 *            BaseActor to check for overlap
	 * @return direction vector by which actor was translated, null if no
	 *         overlap
	 */
	 ...
	 * 
	 * @param distance
	 *            amount (pixels) by which to enlarge collision polygon width
	 *            and height
	 * @param other
	 ...
	 * 
	 * @param BaseActor
	 *            whose size determines the world bounds (typically a background
	 *            image)
	 */
	 ...
	 * the given class name or whose class extends the class with the given
	 * name. If no instances exist, returns an empty list. Useful when coding
	 ...
	 * @return list of instances of the object in stage which extend with the
	 *         given class name
	 */
	 ...
	 * 
	 * @param dt
	 *            elapsed time (second) since last frame (supplied by Stage act
	 *            method)
	 */
	 ...
	 * If no animation has been set or object is invisible, nothing will be
	 * drawn.
	 * 
	 * @param batch
