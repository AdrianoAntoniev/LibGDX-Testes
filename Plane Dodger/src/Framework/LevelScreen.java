...
public class LevelScreen extends BaseScreen {
	...
	public void initialize() {
		...
		plane = new PlayerPlane(100, 500, mainStage);
	...
	public void update(float dt) {
		...
		for(BaseActor star: BaseActor.getList(mainStage, "Framework.Star")) {
		...
		if(enemyTimer > enemySpawnInterval) {
			EnemyPlane enemy = new EnemyPlane(800, MathUtils.random(100,500), mainStage);
		...
		for (BaseActor enemy: BaseActor.getList(mainStage, "Framework.EnemyPlane")) {
			gameOver = plane.overlaps(enemy);
